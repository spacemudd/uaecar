        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="{{ asset('front/img/white-logo.png') }}"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="{{ asset('back/assets/img/profile.jpg') }}"
                        alt="..."
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                ...
                                <div class="flag">
                                    <img
                                        src="{{ asset('back/assets/img/flags/id.png') }}"
                                        alt="indonesia"
                                    />
                                </div>
                                </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="flag">
                                            <img
                                                src="{{ asset('back/assets/img/flags/us.png') }}"
                                                alt="united states"
                                            />
                                        </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                    <div class="flag">
                                        <img
                                            src="{{ asset('back/assets/img/flags/au.png') }}"
                                            alt="australia"
                                        />
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="flag">
                                        <img
                                            src="{{ asset('back/assets/img/flags/ru.png') }}"
                                            alt="russia"
                                        />
                                    </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                    <div class="flag">
                                        <img
                                            src="{{ asset('back/assets/img/flags/cn.png') }}"
                                            alt="china"
                                        />
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="flag">
                                        <img
                                            src="{{ asset('back/assets/img/flags/br.png') }}"
                                            alt="brazil"
                                        />
                                    </div>
                                </td>
