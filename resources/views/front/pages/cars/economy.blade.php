...
@section('content')
    ...
    <div class="col-12 text-left"> <!-- Changed from text-center to text-left -->
        <h2 class="display-4 mb-4" style="font-family: 'Calisto MT', serif;">Economy Cars</h2>
    </div>
</div>

        <div class="row gy-2">
            @foreach($cars as $car)
            @if(in_array(strtolower($car->categories), ['economy'])) <!-- Check if category is 'economy' or 'premium' -->
                <!-- Car Card -->
