        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            ...
            <div class="relative w-full bg-white">
                <div class="flex flex-col items-center justify-center text-white py-10"
                    ...
                    <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <h2 class="text-5xl my-10 text-center lg:text-left">Testimonials</h2>
                        <p class="mt-2 text-3xl text-center lg:text-left">Read what our clients have experienced with us.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative w-full bg-white py-10">
                <div class="flex flex-col items-center justify-center text-black">
                    <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <div class="text-center"><i>Content coming soon</i></div>
                    </div>
                </div>
                <bottom-layout/>
            </div>
